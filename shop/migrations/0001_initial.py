# Generated by Django 3.1.3 on 2022-11-19 20:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('sellingProRegisteryID', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('orderType', models.CharField(choices=[('Single', 'Single'), ('Multiple', 'Multiple')], max_length=10)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('coupon', django_mysql.models.ListCharField(models.CharField(max_length=100), max_length=2525, size=25)),
